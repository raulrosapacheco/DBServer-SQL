...
-- 21 | FILMES
-- 53 | ROUPAS
-- Como estamos trabalhando com OR e a segunda condição é opicional
-- Colocamos na primeira condição quem tem mais chance de uma saida verdadeira, 
-- pois a segunda condição não será checada nesse caso

SELECT * FROM funcionarios WHERE departamento = 'Roupas' OR departamento = 'Filmes';

-- O gestor de marketing pediu a lista das funcionárias que trabalham no departamento
-- de filmes ou no departamento lar. ELe necessita enviar um email paras as colaboradoras desses
-- dois setores
...
-- Traga os funcionários do sexo masculino ou os funcionários no setor jardim
SELECT * FROM funcionarios 
WHERE 
sexo = 'Masculino' 
OR 
